...
# Introduction to Joomdle

Joomdle is a powerful integration bridge that connects **Joomla** and **Moodle**, allowing you to combine the flexibility of Joomla's content management system with the robust e-learning capabilities of Moodle.
...
With Joomdle, your users can log in once and access both platforms transparently, creating a unified experience for learners and administrators alike.
...
Joomdle is ideal for:

- **Educational institutions** looking to run a branded e-learning portal
- **Businesses** offering employee training through a corporate website
- **Course providers** who want to sell online courses with a professional web presence
- **Communities** combining a Joomla-powered website with Moodle-based learning

## Getting Started

Head to the [Installation](./category/installation) section to begin setting up Joomdle on your site.
